...
export const INITIAL_CHECKLIST_RAW = [
  ...
  { code: 'SUMA-65', titlePt: 'Relatório de Inspeção da Malha Elétrica', titleEn: 'Electrical Loop Continuity & Safety tests', titleEs: 'Reporte de Pruebas de Violet Eléctrica', category: 'SUMARIO' },
