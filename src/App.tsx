      ...
      <header className="bg-[#0b0f19] border-b border-gray-800/80 sticky top-0 z-40 px-4 sm:px-6 py-4 print:hidden">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-tr from-orange-500 to-yellow-400 p-[1.5px] rounded-md shadow-lg shadow-orange-500/5">
          ...
          <div className="flex items-center flex-wrap gap-3 sm:gap-4 justify-center">
            ...
            <button
              ...
              className="p-2 border border-gray-800/80 hover:bg-red-950/10 text-gray-400 hover:text-red-400 rounded-lg transition"
              title={t.logout}
            >
