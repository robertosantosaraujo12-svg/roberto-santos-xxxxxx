...
Roberto Santos de Araujo`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Intro Header */}
      <div className="bg-gradient-to-r from-cyan-500/10 to-transparent border-l-4 border-cyan-500 p-5 rounded-r-xl bg-gray-950/40">
      ...
      {activeTab === 'cartilha' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-3">
            <h3 className="text-xs font-bold font-mono text-cyan-500 uppercase tracking-widest block">
            ...
            <div className="space-y-2">
              {[
                ...
                return (
                  ...
                  >
                    <div className={`p-1.5 rounded-md ${isSelected ? 'bg-cyan-500 text-black' : 'bg-gray-900 text-cyan-500/80'} shrink-0`}>
            ...
            <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-4 font-mono text-[11px] leading-relaxed text-gray-400">
              ...
              Quando enviar a plataforma aos clientes, peça que entrem com seu código de inquilino exclusivo (ex: <code className="text-cyan-500 font-bold">cliente-demo</code> / senha: <code className="text-cyan-500 font-bold">demo123</code>). Eles verão apenas os seus respectivos projetos de forma restrita e totalmente isolada!
            </div>
          </div>
            ...
            {activeWalkthroughStep === 0 && (
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 bg-cyan-500/10 text-cyan-500 border border-cyan-500/20 rounded-md">
                ...
                <div className="bg-[#07090e] border border-gray-900 p-5 rounded-lg max-w-sm mx-auto space-y-3 font-mono text-xs">
                  ...
                  <div>
                    ...
                    <div className="mt-1 px-3 py-2 bg-gray-950 border border-gray-800 rounded font-bold text-white flex justify-between items-center">
                      ...
                      <span className="text-[9px] bg-cyan-500/10 text-cyan-500 border border-cyan-500/20 px-1 rounded">MAPPED</span>
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="p-2.5 bg-cyan-500/5 border border-cyan-500/10 rounded text-[10px] text-gray-400 text-left">
                    🔑 <strong className="text-cyan-400">Restrição Absoluta</strong>: O inquilino só visualiza projetos cujo campo <em>Client</em> corresponda estritamente à sua chave.
                  </div>
                </div>
              </div>
            )}
                ...
                <div className="bg-[#07090e] border border-gray-900 p-4 rounded-lg space-y-3 font-mono text-xs">
                  ...
                  <div className="p-3 bg-gray-950 border border-gray-850 rounded flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    <div className="space-y-0.5">
                      <div className="flex items-center gap-2">
                        <span className="bg-cyan-500/10 text-cyan-500 border border-cyan-500/20 px-1.5 py-0.2 rounded font-bold text-[10px]">SUMA-30</span>
                    ...
                    {demoSigned ? (
                      <div className="space-y-2">
                        ...
                        <div className="bg-gray-900/55 p-2 rounded text-[10px] text-left space-y-1 text-gray-450 border border-gray-850">
                          ...
                          <div><span className="text-gray-500 uppercase">Firma Digital (SHA-256):</span> <code className="text-cyan-500 text-[9px] break-all">{demoHash}</code></div>
                        </div>
                        <button
                          onClick={() => {
                            setDemoSigned(false);
                          ...
                          className="px-2 py-1 bg-cyan-950/20 border border-cyan-900/35 hover:bg-cyan-950/40 text-cyan-400 rounded text-[9px] cursor-pointer"
                        >
                          Limpar Assinatura
                        </button>
                      </div>
                      ...
                      <div className="py-2 space-y-2">
                        <p className="text-[11px] text-gray-400">O arquivo <strong className="text-cyan-500 font-sans">P78-LP-REP-4001.pdf</strong> está aguardando homologação do inspetor.</p>
                        <button
                          onClick={() => {
                            setDemoSigned(true);
                            setDemoHash('SHA256:e3b0c44298fc1c149afbf4c8996f' + Math.floor(Math.random()*1000000).toString(16) + '4ca495991b7852b855');
                          }}
                          className="px-3 py-1.5 bg-cyan-500 hover:bg-cyan-600 text-black font-bold rounded text-xs transition-all cursor-pointer inline-flex items-center gap-1.5"
                        >
                          <ShieldCheck className="w-4 h-4" />
        ...
        <div className="space-y-6">
          <div className="bg-gray-950/40 border border-gray-900 p-5 rounded-xl space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <button
                ...
                className="px-2.5 py-1 bg-cyan-500/10 border border-cyan-500/20 text-cyan-500 hover:bg-cyan-500 hover:text-black rounded text-[10px] font-mono font-bold uppercase transition cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 pt-2">
              ...
              <div className="space-y-2 bg-gray-900/30 p-3 rounded-lg border border-gray-900">
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className="text-cyan-500 font-bold">{clientsCount} clientes</span>
                </div>
                <input 
                  type="range" 
                  min="1" 
                  ...
                  className="w-full accent-cyan-500 h-1 bg-gray-950 rounded-lg cursor-pointer"
                />
              ...
              <div className="space-y-2 bg-gray-900/30 p-3 rounded-lg border border-gray-900">
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className="text-cyan-500 font-bold">{requirementsPerClient} docs</span>
                </div>
                <input 
                  type="range" 
                  min="5" 
              ...
              <div className="lg:col-span-2 space-y-2 bg-gray-900/30 p-3 rounded-lg border border-gray-900">
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className="text-cyan-400 font-bold">R$ {fixedCosts.toLocaleString('pt-BR')}</span>
                </div>
                <input 
                  type="range" 
                  min="5000" 
              ...
              <div className="lg:col-span-2 space-y-2 bg-gray-900/30 p-3 rounded-lg border border-gray-900">
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className="text-cyan-500 font-bold">R$ {cacPerClient.toLocaleString('pt-BR')}</span>
                </div>
                <input 
                  type="range" 
                  min="500" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 font-mono">
            ...
            <div className={`bg-[#0b0f19] border p-5 rounded-xl space-y-1 relative overflow-hidden ${
              clientsCount >= breakEvenClients ? 'border-cyan-500/30' : 'border-cyan-500/30'
            }`}>
              <span className="text-[10px] text-cyan-400 uppercase tracking-wider block">Ponto de Equilíbrio (Mínimo)</span>
              <p className="text-xl sm:text-2xl font-black text-cyan-500">{breakEvenClients} {breakEvenClients === 1 ? 'Cliente Ativo' : 'Clientes Ativos'}</p>
              ...
              <div className="absolute top-1/2 right-4 -translate-y-1/2 text-cyan-500/5 text-5xl font-black select-none pointer-events-none">BREAK</div>
            </div>

            {/* Total maintenance costs */}
            <div className="bg-[#0b0f19] border border-gray-800 p-5 rounded-xl space-y-1 relative overflow-hidden">
              <span className="text-[10px] text-gray-400 uppercase tracking-wider block">Custo de Operação (OPEX)</span>
              <p className="text-xl sm:text-2xl font-black text-cyan-400">R$ {fixedCosts.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
              ...
              <div className="absolute top-1/2 right-4 -translate-y-1/2 text-cyan-500/5 text-5xl font-black select-none pointer-events-none">OPEX</div>
            </div>

            {/* Net Profit card */}
            <div className={`bg-[#0b0f19] border p-5 rounded-xl space-y-1 relative overflow-hidden ${
              netProfit >= 0 ? 'border-emerald-500/30' : 'border-cyan-500/30'
            }`}>
              <span className="text-[10px] text-gray-400 uppercase tracking-wider block">Lucro Líquido Mensal</span>
              <p className={`text-xl sm:text-2xl font-black ${netProfit >= 0 ? 'text-teal-400' : 'text-cyan-500'}`}>
            ...
            <div className="bg-[#0b0f19] border border-gray-800 p-5 rounded-xl space-y-1 relative overflow-hidden">
              ...
              <p className="text-xl sm:text-2xl font-black text-cyan-500">{paybackMonths} {paybackMonths === 1 ? 'Mês' : 'Meses'}</p>
              ...
              <div className="absolute top-1/2 right-4 -translate-y-1/2 text-cyan-500/5 text-5xl font-black select-none pointer-events-none">ROI</div>
            </div>
          </div>
          ...
          <div className="bg-[#0b0f19] border border-gray-900 rounded-xl p-5 sm:p-6 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1 font-mono text-xs">
                ...
                <div className="h-8 w-full bg-gray-950 rounded overflow-hidden flex border border-gray-900 p-1">
                  ...
                  <div 
                    ...
                    className="h-full bg-cyan-500/20 border border-cyan-500/40 rounded flex items-center justify-center text-[9px] text-cyan-400 font-bold"
                  >
                    OPEX
                  </div>
                  {/* Net profit portion */}
                  {netProfit > 0 ? (
                    ...
                    <div className="flex-1 bg-cyan-950/40 text-cyan-500 text-[10px] flex items-center justify-center">
              ...
              {/* Insight block */}
              <div className="bg-cyan-500/5 border border-cyan-500/20 p-4 rounded-lg flex items-start gap-3 text-xs leading-relaxed">
                <Info className="w-5 h-5 shrink-0 text-cyan-500 mt-0.5" />
                <div className="space-y-1 text-gray-300">
                  <strong className="text-cyan-500 font-mono text-[11px] uppercase block">ANÁLISE DE VIABILIDADE E PONTO DE EQUILÍBRIO (PREMISSA DE NEGÓCIO DE EXCELÊNCIA)</strong>
                  <div className="space-y-2 text-gray-300">
                    ...
                    <p className="mt-1">
                      Para cobrir seu custo fixo operacional de <strong>R$ {fixedCosts.toLocaleString('pt-BR')}</strong>, o seu <strong className="text-cyan-400">Ponto de Equilíbrio (Break-Even) é de {breakEvenClients} {breakEvenClients === 1 ? 'cliente ativo' : 'clientes ativos'}</strong> por mês.
                    </p>
      ...
      {activeTab === 'protection' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="bg-gray-950/40 border border-gray-900 rounded-xl p-5 space-y-4">
              ...
              <div className="space-y-3 text-xs text-gray-400 leading-relaxed leading-normal text-left font-sans">
                ...
                <ul className="space-y-2 font-mono text-[11px] list-disc pl-4 text-gray-300">
                  <li>
                    <strong className="text-cyan-550">1. Termos de Uso e NDA Digital</strong>: Um acordo eletrônico de não-divulgação e sigilo aceito pelo cliente com 1 único clique <em>antes</em> do primeiro acesso ao sistema.
                  </li>
                  <li>
                    <strong className="text-cyan-550">2. Patente & Direito de Software</strong>: O código visual, arquitetura e fluxo de 71 quesitos do Piramidy são protegidos pela Lei de Software (Lei Nº 9.609/98).
                  </li>
                  <li>
                    <strong className="text-cyan-550">3. Custódia Criptográfica</strong>: Assinar digitalmente as ações cria trilhas de auditoria auditáveis que provam legalmente que eles utilizaram sua tecnologia proprietária.
                  </li>
                </ul>
              </div>

              {/* IP legal certificate banner */}
              <div className="bg-cyan-500/5 border border-cyan-500/20 p-3 rounded text-[10px] text-cyan-500 font-mono text-left space-y-1">
          ...
          <div className="lg:col-span-7 bg-[#0b0f19] border border-gray-900 rounded-xl p-5 sm:p-6 space-y-4">
            <div>
              <h4 className="text-xs font-bold font-mono text-cyan-500 uppercase tracking-wider">Simulador de Acordo de Confidencialidade (NDA)</h4>
            ...
            <div className="bg-gray-950 p-4 rounded-lg border border-gray-900 space-y-3 font-mono text-xs text-left">
              ...
              <div className="flex items-center gap-2 pt-1">
                <input 
                  ...
                  className="rounded bg-gray-900 border-gray-800 text-cyan-500 focus:ring-0 cursor-pointer h-4 w-4"
                />
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-cyan-500 hover:bg-cyan-600 disabled:opacity-30 disabled:hover:bg-cyan-500 text-black font-bold rounded transition-all cursor-pointer flex items-center gap-1.5 shadow-md shadow-cyan-500/5"
                >
                  {isNdaSigningActive ? (
                    <>
                  ...
                  <tbody className="divide-y divide-gray-850 text-gray-300">
                    {signedNdas.map((n) => (
                      <tr key={n.id} className="hover:bg-gray-900/10">
                        <td className="p-2 font-bold text-cyan-500">{n.id}</td>
          ...
          <div className="lg:col-span-8 bg-[#0b0f19] border border-gray-900 rounded-xl p-5 sm:p-6 space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-gray-900">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-cyan-500 hover:bg-cyan-600 text-black font-bold rounded text-xs transition flex items-center gap-1.5 shadow cursor-pointer"
              >
                {inviteCopied ? (
                  <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-4">
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-bold font-mono text-xs transition-all cursor-pointer flex items-center justify-center gap-2 shadow ${
                  nfseSimulationStep >= 0 && nfseSimulationStep < 3
                    ...
                    : 'bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-black active:scale-[0.98]'
                }`}
              >
                ...
                <div className="space-y-2 border-t border-gray-900 pt-3">
                  ...
                  <div className="grid grid-cols-4 gap-1.5 font-mono text-[9px] text-center">
                    <div className={`p-1.5 rounded border transition-all ${
                      nfseSimulationStep >= 0 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                    }`}>
                      1. Payload
                    </div>
                    <div className={`p-1.5 rounded border transition-all ${
                      nfseSimulationStep >= 1 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                    }`}>
                      2. Assina A1
                    </div>
                    <div className={`p-1.5 rounded border transition-all ${
                      nfseSimulationStep >= 2 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                    }`}>
                      3. SOAP HTTPS
                    </div>
                    <div className={`p-1.5 rounded border transition-all ${
            ...
            <div className="bg-gray-950/40 border border-gray-900 rounded-xl p-4 space-y-2 text-left">
              <span className="text-[10px] font-bold font-mono text-cyan-500 uppercase tracking-widest block">📝 REQUISITOS DE INTEGRAÇÃO EM SANTOS/SP</span>
          ...
          <div className="lg:col-span-7 space-y-4 text-left">
            ...
            <div className="bg-[#0b0f19] border border-gray-900 rounded-xl p-5 space-y-3">
              <div className="flex justify-between items-center pb-2 border-b border-gray-900">
                ...
                <span className="text-[10px] font-mono bg-gray-900 border border-gray-800 text-cyan-500 px-2 py-0.5 rounded uppercase">
              ...
              <div className="bg-[#0b0f19] border border-gray-900 rounded-xl p-4 space-y-2">
                ...
                <div className="space-y-1 font-mono text-[10px] bg-gray-950 p-3 rounded border border-gray-900 max-h-36 overflow-y-auto leading-relaxed">
                  {nfseSimulationLogs.map((log, idx) => (
                    <div key={idx} className={log.startsWith('✔') ? 'text-emerald-400 font-bold' : 'text-cyan-500'}>
            ...
            <div className="bg-gray-950/60 border border-gray-900 rounded-xl p-5 space-y-3">
              <div className="flex items-center justify-between pb-2 border-b border-gray-900">
                ...
                <span className="text-xs font-mono font-bold text-cyan-500">{emittedInvoices.length} Ativas</span>
              </div>
                ...
                {emittedInvoices.map((inv) => (
                  <div key={inv.id} className="bg-gray-900/60 border border-gray-850 p-3 rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-xs font-mono">
                    ...
                    <div className="flex sm:flex-col items-end gap-2 sm:gap-1 text-right w-full sm:w-auto">
                      <span className="text-cyan-500 font-bold block">R$ {inv.value.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#0b0f19] border border-gray-900 rounded-xl p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-left">
            <div className="space-y-1">
              <div className="flex items-center gap-2 text-cyan-500 font-mono text-[11px] font-bold font-sans">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <div className="absolute top-0 right-0 w-8 h-8 bg-cyan-500/10 flex items-center justify-center rounded-bl-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-left">
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="bg-gray-950/60 border border-gray-900 rounded-xl p-5 space-y-4">
                  ...
                  <div className="space-y-3 font-mono text-xs">
                    <div>
                      ...
                      <input 
                        ...
                        className="mt-1 w-full bg-gray-900 border border-gray-800 text-gray-200 p-2 rounded focus:outline-none focus:border-cyan-500"
                      />
                    </div>
                    <div className="grid grid-cols-3 gap-2">
                      <div className="col-span-1">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 bg-gray-900 p-1 rounded border border-gray-850">
                        <button
                          ...
                          className={`py-1.5 rounded text-[10px] font-bold transition cursor-pointer ${
                            msProjectMode === 'xml_import' ? 'bg-cyan-500 text-black' : 'text-gray-400 hover:text-white'
                          }`}
                        >
                          Manual XML Import
                        </button>
                        <button
                          ...
                          className={`py-1.5 rounded text-[10px] font-bold transition cursor-pointer ${
                            msProjectMode === 'rest_online' ? 'bg-cyan-500 text-black' : 'text-gray-400 hover:text-white'
                          }`}
                        >
                          REST API Cloud
                        </button>
                ...
                {isSyncing && (
                  <div className="space-y-2 border-t border-gray-900 pt-3">
                    ...
                    <div className="grid grid-cols-4 gap-1.5 font-mono text-[9px] text-center">
                      <div className={`p-1.5 rounded border transition-all ${
                        syncStep >= 0 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                      }`}>
                        1. Handshake
                      </div>
                      <div className={`p-1.5 rounded border transition-all ${
                        syncStep >= 1 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                      }`}>
                        2. Schema
                      </div>
                      <div className={`p-1.5 rounded border transition-all ${
                        syncStep >= 2 ? 'bg-cyan-500/15 border-cyan-500 text-white' : 'bg-gray-900 border-gray-850 text-gray-600'
                      }`}>
                        3. Transfer
                      </div>
                      <div className={`p-1.5 rounded border transition-all ${
              ...
              <div className="bg-gray-950/45 border border-gray-900 rounded-xl p-4 space-y-2">
                <span className="text-[10px] font-bold font-mono text-cyan-500 uppercase tracking-widest block">🔒 CRIPTOGRAFIA E ISOLAMENTO DE DADOS</span>
                <p className="text-[11px] text-gray-400 leading-relaxed font-sans">
                  {language === 'PT'
            ...
            <div className="lg:col-span-7 space-y-4 text-left">
              ...
              <div className="bg-[#0b0f19] border border-gray-900 rounded-xl p-5 space-y-3">
                <div className="flex justify-between items-center pb-2 border-b border-gray-900 font-mono">
                  ...
                  <span className="text-[10px] bg-gray-900 border border-gray-800 text-cyan-500 px-2 py-0.5 rounded uppercase">
                    API v2.1-NET
                  </span>
                </div>
              ...
              <div className="bg-gray-950/60 border border-gray-900 rounded-xl p-5 space-y-4">
                <div className="flex items-center justify-between pb-2 border-b border-gray-900 font-mono">
                  ...
                  <span className="text-xs font-mono font-bold text-cyan-500 uppercase bg-cyan-500/10 border border-cyan-500/20 px-2 py-0.5 rounded">
                      ...
                      <tbody className="divide-y divide-gray-850 text-gray-300">
                        {sapMappedLocations.map((loc) => (
                          <tr key={loc.id} className="hover:bg-gray-900/10">
                            <td className="p-2 font-bold text-cyan-500">{loc.id}</td>
                            <td className="p-2 text-white font-bold">{loc.techLoc}</td>
                            <td className="p-2 text-gray-450">{loc.equipment}</td>
                            <td className="p-2 text-right">
                              <span className="text-[9px] bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 px-1.5 py-0.2 rounded uppercase font-sans">
                                {loc.status}
                              </span>
                            </td>
                          </tr>
                      ...
                      <tbody className="divide-y divide-gray-850 text-gray-300">
                        {totvsSyncedOS.map((os) => (
                          <tr key={os.id} className="hover:bg-gray-900/10">
                            <td className="p-2 font-bold text-cyan-500">{os.id}</td>
                      ...
                      <tbody className="divide-y divide-gray-850 text-gray-300">
                        {jiraIssues.map((issue) => (
                          <tr key={issue.id} className="hover:bg-gray-900/10">
                            ...
                            <td className="p-2">
                              <span className="text-[9px] bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 px-1 rounded uppercase font-sans font-bold">
                                {issue.priority}
                              </span>
                            </td>
                            <td className="p-2 text-right">
                              <span className="text-[9px] bg-cyan-500/15 text-cyan-500 border border-cyan-500/35 px-1.5 py-0.2 rounded uppercase font-sans font-bold">
                                {issue.status}
                              </span>
                            </td>
                          </tr>
                      ...
                      <tbody className="divide-y divide-gray-850 text-gray-300">
                        {msProjectTimeline.map((item, idx) => (
                          <tr key={idx} className="hover:bg-gray-900/10">
                            ...
                            <td className="p-2 text-cyan-500 font-sans">{item.mappedItem}</td>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-gray-900/40 p-5 border border-gray-800 rounded-xl space-y-4">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <span className="text-[10px] bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 px-3 py-1 rounded font-mono font-bold uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="bg-gray-950 border border-gray-900 rounded-xl p-5 space-y-4">
                        ...
                        invoices.map((inv) => {
                          ...
                          return (
                            <tr key={inv.id} className="hover:bg-gray-900/20">
                              <td className="p-3 font-bold text-cyan-500 font-mono">{inv.id}</td>
                              <td className="p-3">
                                <div>
                              ...
                              <td className="p-3 text-center">
                                {isOverdue ? (
                                  <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold ${
                                    isPastTenDays ? 'bg-cyan-950 text-cyan-400 border border-cyan-500/40' : 'bg-cyan-950 text-cyan-400'
                                  }`}>
                ...
                <div className="bg-cyan-950/10 border border-cyan-900/30 rounded p-3 text-[11px] text-cyan-500 font-mono leading-relaxed">
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="bg-gray-950 border border-gray-900 rounded-xl p-5 space-y-4">
                <div className="border-b border-gray-900 pb-3">
                  <h4 className="text-xs font-bold text-gray-300 font-mono uppercase tracking-wider flex items-center gap-1.5">
                    <Lock className="w-4 h-4 text-cyan-500 animate-pulse" />
                    ...
                    companies.map((co) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Reason breakdown */}
                          {isCurrentlyBlocked && (
                            <p className="text-[10px] text-cyan-400 bg-cyan-950/20 border border-cyan-900/30 rounded p-1.5 font-mono text-left">
