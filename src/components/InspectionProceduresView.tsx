...
export default function InspectionProceduresView({ language }: InspectionProceduresViewProps) {
  ...
  const getCategoryBadgeColor = (type: string) => {
    switch (type) {
      ...
      case 'WELDING': return 'bg-red-500/10 text-red-400 border-red-500/20';
      ...
      <section className="bg-gray-900/40 p-4 border border-gray-800 rounded-lg flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex-1 w-full relative">
          ...
          <input
            ...
            className="w-full bg-[#111827] border border-gray-750 focus:border-red-500 rounded pl-9 pr-3 py-2 text-xs text-white focus:outline-none placeholder-gray-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <select
            ...
            className="bg-[#111827] border border-gray-750 text-xs text-gray-300 rounded p-1.5 focus:outline-none focus:border-red-500 cursor-pointer w-full md:w-auto"
          >
        ...
        <div className="flex gap-2 w-full md:w-auto justify-end">
          <button
            ...
            className="px-3 py-1.5 bg-red-500 hover:bg-red-600 text-black font-semibold text-xs rounded transition flex items-center gap-1.5 cursor-pointer shadow-md shadow-red-500/5 whitespace-nowrap"
          >
            ...
            return (
              <article 
                ...
                className={`border rounded-xl transition-all cursor-pointer overflow-hidden ${
                  isExpanded 
                    ? 'bg-[#111827]/70 border-red-500/50 shadow-lg shadow-red-500/5' 
                ...
                <div className="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="text-red-500 font-mono text-xs font-bold bg-red-500/10 px-2 py-0.5 rounded border border-red-500/20">
                        {proc.code}
                      </span>
                  ...
                  <div className="flex items-center gap-2 self-end sm:self-auto">
                    ...
                    <div className="flex gap-1">
                      ...
                      <label 
                        className="p-2 bg-gray-950 border border-gray-850 hover:border-red-500/50 hover:bg-red-500/10 text-gray-400 hover:text-red-500 rounded transition cursor-pointer"
                  ...
                  <div className="border-t border-gray-850 bg-gray-950/50 p-5 space-y-4">
                        ...
                        <ol className="space-y-2 text-xs font-mono text-gray-300">
                          {steps.map((st, sIdx) => (
                            <li key={sIdx} className="flex gap-2.5 items-start bg-gray-900/60 p-2.5 rounded border border-gray-850/40">
                              <span className="w-4 h-4 rounded bg-red-500/10 text-red-500 text-[10px] font-bold flex items-center justify-center shrink-0 border border-red-500/20">
                                {sIdx + 1}
                              </span>
                          ...
                          <div className="bg-[#0f1524]/60 p-3 rounded border border-gray-850/60 flex flex-wrap gap-2 items-center">
                            ...
                            {proc.linkedDocs.length === 0 ? (
                              ...
                              proc.linkedDocs.map(docCode => (
                                <span 
                                  key={docCode} 
                                  className="text-[10px] bg-red-500/10 text-red-400 border border-red-500/20 font-mono font-bold px-2 py-0.5 rounded"
                                >
                                  {docCode}
                                </span>
                              ))
                    ...
                    <div className="pt-4 border-t border-gray-850 space-y-3">
                      <div className="flex items-center justify-between flex-wrap gap-2">
                        ...
                        <label 
                          className="px-2.5 py-1 bg-red-500/10 border border-red-500/25 hover:bg-red-500/25 text-red-400 rounded text-[11px] font-semibold transition flex items-center gap-1.5 cursor-pointer"
          ...
          <div className="bg-[#111827] border border-gray-800 rounded-xl max-w-3xl w-full p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto text-gray-200 font-mono text-xs">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-950 border border-gray-750 rounded px-2.5 py-1.5 text-xs text-white mt-1 focus:border-red-500"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-gray-950 border border-gray-750 text-xs rounded px-2.5 py-1.5 text-white mt-1 focus:border-red-500"
                  >
                    <option value="RECEIVING">{uiText.typeReceiving}</option>
                    <option value="WELDING">{uiText.typeWelding}</option>
                    <option value="NDT">{uiText.typeNdt}</option>
              ...
              <div className="space-y-3.5 bg-gray-950/40 p-3 rounded-lg border border-gray-850/60">
                <h4 className="text-[10px] text-red-500 font-bold uppercase tracking-wider">{uiText.objectiveLabel}</h4>
              ...
              <div className="space-y-3.5 bg-gray-950/40 p-3 rounded-lg border border-gray-850/60">
                <h4 className="text-[10px] text-red-500 font-bold uppercase tracking-wider">{uiText.stepsLabel}</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div>
              ...
              <div className="space-y-3.5 bg-gray-950/40 p-3 rounded-lg border border-gray-850/60">
                <h4 className="text-[10px] text-red-500 font-bold uppercase tracking-wider">{uiText.instrumentsLabel}</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-gray-800">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-red-500 hover:bg-red-600 text-black text-xs font-extrabold rounded flex items-center gap-1 cursor-pointer"
                >
