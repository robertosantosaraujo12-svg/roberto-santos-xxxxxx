    ...
    <div className="space-y-6">
          ...
          <div className="flex gap-2">
            {isBlocked ? (
              ...
              <button
                ...
                className="px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-black text-xs font-bold rounded transition-all cursor-pointer flex items-center gap-1.5 font-mono"
              >
      ...
      {showPreview ? (
        <div className="space-y-8 bg-gray-950 p-6 border border-gray-800 rounded-xl" id="print-area">
          ...
          <div className="p-3 bg-yellow-500/10 border border-yellow-500/30 text-yellow-500 font-mono text-[10px] sm:text-xs rounded-md print:hidden">
            💡 {language === 'PT' 
            ...
            <div className="min-h-[750px] flex flex-col justify-between border-2 border-black p-8 font-serif relative page-break">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-mono border-t border-black pt-6">
                ...
                <div>
                  ...
                  <p className="font-bold uppercase text-yellow-600">{project.revision}</p>
                </div>
              </div>
                  ...
                  {itemsWithPages.map((item) => (
                    ...
                    >
                      <div className="flex items-center gap-1.5 truncate max-w-lg text-black font-semibold">
                        <span className="text-yellow-600 font-bold">{item.code}</span>
              ...
              {itemsWithPages.map((item) => (
                ...
                >
                  ...
                  <div className="border-b-2 border-black pb-3 flex justify-between items-start gap-4">
                    <div>
                      <span className="text-[10px] text-yellow-600 font-bold">{item.code} - GESTÃO DE CONFORMIDADE</span>
                    ...
                    <div className="text-right text-[10px]">
                      <p>DOC REFERÊNCIA</p>
                      <p className="font-bold text-yellow-600">{project.docNumber}</p>
                    </div>
                  </div>
                  ...
                  <div className="my-auto space-y-6">
                    ...
                    <div className="space-y-3 max-w-xl mx-auto">
                      ...
                      {item.emissions.length === 0 ? (
                        <div className="p-3 bg-yellow-50 border border-yellow-200 rounded text-[11px] text-yellow-700 italic">
                          * {language === 'PT' 
                          ...
                          {item.emissions.map((em) => (
                            <div key={em.id} className="p-3 bg-gray-50 border border-gray-200 rounded font-mono text-[10px] space-y-1.5">
                              ...
                              {em.signature ? (
                                ...
                                <div className="mt-2.5 p-1.5 bg-yellow-50 border border-yellow-100 text-yellow-800 text-[9px]">
        ...
        <section className="bg-[#111827]/40 border border-gray-800 rounded-xl p-6 sm:p-8 text-center font-mono space-y-6">
          <div className="space-y-2">
            <BookOpen className="w-12 h-12 text-yellow-500/80 mx-auto animate-pulse" />
          ...
          <div className="border border-gray-800 rounded-lg p-4 bg-gray-950/50 max-w-2xl mx-auto text-left space-y-3 font-sans">
            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-xs font-bold text-yellow-500 uppercase tracking-wider font-mono">
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        className="mt-0.5 rounded border-gray-700 text-yellow-500 focus:ring-yellow-500 focus:ring-offset-gray-950 bg-gray-950 cursor-pointer"
                      />
                      <div className="text-xs leading-tight">
                        <span className="font-mono font-bold text-yellow-500 text-[10px] block">{item.code}</span>
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-bold rounded cursor-pointer mt-2 transition-all ${
              databookItems.length === 0 
                ...
                : 'bg-yellow-500 hover:bg-yellow-600 text-black shadow-lg hover:shadow-yellow-500/10'
            }`}
          >
            {t.generateBtn}
          </button>
