...
export default function Login({
  ...
  return (
    <div className="min-h-screen bg-[#0a0f18] text-gray-100 flex flex-col justify-between p-4 selection:bg-violet-500 selection:text-black">
      ...
      <header className="max-w-6xl w-full mx-auto flex justify-between items-center py-4 border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-violet-500 via-violet-600 to-violet-400 p-[1.5px] rounded">
            <div className="w-full h-full bg-[#0a0f18] flex items-center justify-center rounded">
              <span className="font-mono text-xl font-bold tracking-tighter text-violet-500">P</span>
            </div>
          </div>
          <div>
            <h1 className="font-sans font-bold tracking-tight text-white flex items-center gap-1.5">
              PIRAMID <span className="text-violet-500 text-xs border border-violet-500/40 px-1 py-0.2 rounded font-mono uppercase">ENERGY GOVERNANCE</span>
            </h1>
            ...
            {(['PT', 'EN', 'ES'] as Language[]).map((lang) => (
              <button
                ...
                className={`px-2 py-0.5 text-xs rounded font-mono font-medium transition-all ${
                  language === lang
                    ? 'bg-violet-500 text-black shadow-sm font-semibold'
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-2">
        <div className="max-w-md w-full bg-[#111827] border border-gray-800 shadow-2xl rounded-xl p-8 relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-500 via-violet-500 to-violet-600" />
          ...
          {errorMsg && (
            <div className="mb-6 p-3 bg-violet-950/40 border border-violet-800/80 rounded flex items-start gap-2 text-violet-200 text-xs">
              <AlertTriangle className="w-4 h-4 shrink-0 mt-0.5 text-violet-500" />
              <span>{errorMsg}</span>
            </div>
          )}
          ...
          {!isRegisterMode ? (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between p-2.5 bg-gray-900/60 border border-gray-800/80 rounded-lg">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="accent-violet-500 w-4 h-4 rounded border-gray-700 bg-gray-800 text-violet-500 cursor-pointer"
                  />
                  <span className="text-xs text-violet-500 font-mono flex items-center gap-1">
              ...
              {isAdminMode ? (
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-3 text-violet-500">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 rounded px-3 py-2 pl-10 text-sm text-white focus:outline-none placeholder-gray-500 font-mono"
                      required
                    />
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-violet-500 rounded px-3 py-2 text-sm text-white focus:outline-none cursor-pointer"
                    >
                      <option value="">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 rounded px-3 py-2 text-sm text-white focus:outline-none placeholder-gray-500 font-mono"
                    />
                    {selectedCompanyId && (
                      <p className="text-[10px] text-gray-500 font-mono">
              ...
              <button
                type="submit"
                className="w-full py-2.5 px-4 bg-gradient-to-r from-violet-500 to-violet-500 hover:from-violet-600 hover:to-violet-600 text-black font-semibold rounded focus:outline-none transition-all shadow-md active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 text-sm mt-3"
              >
              ...
              <div className="text-center mt-3">
                <button
                  ...
                  className="text-xs text-violet-500/90 hover:text-violet-400 hover:underline transition-all cursor-pointer font-mono"
                >
                  {t.registerBtn}
                </button>
              </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <h3 className="text-lg font-bold text-center text-violet-500 mb-2">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#1f2937] border border-gray-700 focus:border-violet-500 rounded px-3 py-2 text-xs text-white focus:outline-none"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#1f2937] border border-gray-700 focus:border-violet-500 rounded px-3 py-2 text-xs text-white focus:outline-none font-mono"
                />
              </div>
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 text-xs bg-violet-500 hover:bg-violet-600 text-black font-semibold rounded transition"
                >
      ...
      <footer className="max-w-6xl w-full mx-auto py-6 border-t border-gray-900 text-center space-y-4 font-mono tracking-wider">
        <div className="bg-violet-500/5 border border-violet-500/20 rounded-lg p-4 max-w-3xl mx-auto text-left space-y-3 font-sans">
