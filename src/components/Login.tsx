...
export default function Login({
  ...
  return (
    <div className="min-h-screen bg-[#0a0f18] text-gray-100 flex flex-col justify-between p-4 selection:bg-red-500 selection:text-black">
      ...
      <header className="max-w-6xl w-full mx-auto flex justify-between items-center py-4 border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-red-500 via-red-600 to-yellow-400 p-[1.5px] rounded">
            <div className="w-full h-full bg-[#0a0f18] flex items-center justify-center rounded">
              <span className="font-mono text-xl font-bold tracking-tighter text-red-500">P</span>
            </div>
          </div>
          <div>
            <h1 className="font-sans font-bold tracking-tight text-white flex items-center gap-1.5">
              PIRAMID <span className="text-red-500 text-xs border border-red-500/40 px-1 py-0.2 rounded font-mono uppercase">ENERGY GOVERNANCE</span>
            </h1>
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-2">
        <div className="max-w-md w-full bg-[#111827] border border-gray-800 shadow-2xl rounded-xl p-8 relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500 via-yellow-500 to-red-600" />
          ...
          {!isRegisterMode ? (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between p-2.5 bg-gray-900/60 border border-gray-800/80 rounded-lg">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="accent-red-500 w-4 h-4 rounded border-gray-700 bg-gray-800 text-red-500 cursor-pointer"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-red-500 focus:ring-1 focus:ring-red-500 rounded px-3 py-2 pl-10 text-sm text-white focus:outline-none placeholder-gray-500 font-mono"
                      required
                    />
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-red-500 rounded px-3 py-2 text-sm text-white focus:outline-none cursor-pointer"
                    >
                      <option value="">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1f2937] border border-gray-700 focus:border-red-500 focus:ring-1 focus:ring-red-500 rounded px-3 py-2 text-sm text-white focus:outline-none placeholder-gray-500 font-mono"
                    />
                    {selectedCompanyId && (
                      <p className="text-[10px] text-gray-500 font-mono">
              ...
              <button
                type="submit"
                className="w-full py-2.5 px-4 bg-gradient-to-r from-red-500 to-yellow-500 hover:from-red-600 hover:to-yellow-600 text-black font-semibold rounded focus:outline-none transition-all shadow-md active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 text-sm mt-3"
              >
              ...
              <div className="text-center mt-3">
                <button
                  ...
                  className="text-xs text-red-500/90 hover:text-red-400 hover:underline transition-all cursor-pointer font-mono"
                >
                  {t.registerBtn}
                </button>
              </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#1f2937] border border-gray-700 focus:border-red-500 rounded px-3 py-2 text-xs text-white focus:outline-none"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#1f2937] border border-gray-700 focus:border-red-500 rounded px-3 py-2 text-xs text-white focus:outline-none font-mono"
                />
              </div>
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 text-xs bg-red-500 hover:bg-red-600 text-black font-semibold rounded transition"
                >
      ...
      <footer className="max-w-6xl w-full mx-auto py-6 border-t border-gray-900 text-center space-y-4 font-mono tracking-wider">
        <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-4 max-w-3xl mx-auto text-left space-y-3 font-sans">
