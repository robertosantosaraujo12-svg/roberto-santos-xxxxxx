    ...
    <div className="min-h-screen bg-[#0a0f18] text-gray-100 flex flex-col justify-between p-4 selection:bg-blue-500 selection:text-black">
      ...
      <header className="max-w-6xl w-full mx-auto flex justify-between items-center py-4 border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-400 p-[1.5px] rounded">
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-2">
        <div className="max-w-md w-full bg-[#111827] border border-gray-800 shadow-2xl rounded-xl p-8 relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 via-blue-500 to-blue-600" />
          ...
          {!isRegisterMode ? (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-2.5 px-4 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-600 hover:to-blue-600 text-black font-semibold rounded focus:outline-none transition-all shadow-md active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 text-sm mt-3"
              >
