    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-gray-900/40 p-4 border border-gray-800 rounded-lg">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-violet-500 hover:bg-violet-600 text-black text-xs font-semibold rounded transition flex items-center gap-1 cursor-pointer"
        >
      ...
      {isAdding && (
        <form onSubmit={handleSubmit} className="bg-gray-900/60 border border-violet-500/50 rounded-lg p-6 space-y-4">
          <div className="border-b border-gray-800 pb-2">
            <h3 className="text-sm font-bold text-violet-500 font-mono uppercase tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-[#111827] border border-gray-700 rounded px-2.5 py-1.5 text-xs text-white focus:outline-none focus:border-violet-500"
              />
            </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-violet-500 hover:bg-violet-600 text-black text-xs font-semibold rounded transition"
            >
              {t.createProjectBtn}
            </button>
          </div>
          ...
          return (
            <div 
              ...
              className={`bg-gray-905 bg-gray-900/60 border rounded-xl overflow-hidden shadow-lg transition-all ${
                activeProject?.id === proj.id ? 'border-violet-500 ring-1 ring-violet-500/25' : 'border-gray-800'
              }`}
            >
              ...
              <div className="bg-[#111827] p-4 border-b border-gray-800 flex justify-between items-start gap-4">
                <div>
                  <span className="text-[10px] bg-violet-500/10 text-violet-400 border border-violet-500/20 px-1.5 py-0.5 rounded font-mono uppercase">
                    {proj.category}
                  </span>
                ...
                <button
                  ...
                  className="p-1 hover:bg-violet-950/20 text-gray-500 hover:text-violet-400 rounded transition"
              ...
              <div className="p-4 grid grid-cols-2 gap-x-4 gap-y-3 text-xs text-gray-300 font-mono">
                ...
                <div className="col-span-2 border-t border-gray-800/80 pt-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-violet-500 hover:bg-violet-600 text-black text-[11px] font-bold rounded-md flex items-center gap-1 transition"
                  >
