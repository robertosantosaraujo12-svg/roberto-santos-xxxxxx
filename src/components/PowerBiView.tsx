    ...
    <div className="space-y-6">
      ...
      <section className="bg-[#1f1f1f] text-white p-4 border border-[#303030] rounded-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-2.5">
          {/* Logo sign */}
          <div className="w-8 h-8 bg-purple-400 rounded-sm flex items-center justify-center shadow-lg font-bold text-black font-mono">
            BI
          </div>
          <div>
            <h2 className="text-[#f2c811] text-sm font-bold uppercase tracking-wider font-mono flex items-center gap-1.5">
              ...
              <span className="text-[9px] bg-purple-650 bg-green-500 font-mono text-black px-1.5 py-0.2 rounded font-normal">
                {t.powerBiLive}
              </span>
            </h2>
        ...
        <div className="flex gap-2 text-xs font-mono">
          ...
          <button 
            ...
            className="px-3 py-1.5 bg-[#f2c811] hover:bg-purple-500 text-black rounded font-bold transition flex items-center gap-1 cursor-pointer"
          >
          ...
          {activeTab === 'kpi' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
                ...
                <div className="bg-[#1e1e1e] border-l-4 border-purple-500 p-4">
                ...
                <div className="bg-[#1e1e1e] border-l-4 border-[#ef4444] p-4">
                  ...
                  <p className="text-[9px] text-purple-500 mt-1">Inconformidades operacionais</p>
                </div>
                ...
                <div className="bg-[#1e1e1e] p-4 rounded border border-[#2d2d2d] space-y-3">
                  ...
                  <div className="space-y-3 pt-2 text-xs font-mono">
                    ...
                    <div>
                      ...
                      <div className="h-3 w-full bg-[#121212] overflow-hidden rounded">
                        <div className="h-full bg-purple-400" style={{ width: `${qualityScorePct}%` }} />
                      </div>
                    </div>
                ...
                <div className="bg-[#1e1e1e] p-4 rounded border border-[#2d2d2d] flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-around py-2">
                    <div className="text-center font-mono">
                      <div className="w-16 h-16 rounded-full border-4 border-[#303030] border-t-purple-400 flex items-center justify-center font-extrabold text-sm">
                        94%
                      </div>
          ...
          {activeTab === 'welds' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 font-mono text-center">
                <div className="bg-[#1e1e1e] p-3 border-l-4 border-purple-500 rounded">
                    ...
                    return (
                      <div 
                        ...
                        className={`p-2.5 rounded-lg border flex flex-col items-center justify-between font-mono text-center transition ${
                          isRejected ? 'bg-purple-950/20 border-purple-500/60 hover:bg-purple-950/30 text-purple-400' :
                      ...
                      >
                        ...
                        <div className={`w-2.5 h-2.5 rounded-full mt-2 ${
                          isRejected ? 'bg-purple-500 animate-pulse' :
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 font-mono text-center">
                  ...
                  <div className="bg-[#1e1e1e] p-3 border-l-4 border-purple-500 rounded">
                    ...
                    <span className="text-xl font-extrabold text-purple-400 block mt-0.5">{openCount}</span>
                    <span className="text-[8px] text-purple-500/80">Críticas Sem Solução</span>
                  </div>
                  <div className="bg-[#1e1e1e] p-3 border-l-4 border-purple-500 rounded font-mono">
                    <span className="text-[9px] text-gray-500 block uppercase font-bold">{R.cardPlan}</span>
                    <span className="text-xl font-extrabold text-purple-500 block mt-0.5">{planCount}</span>
                    <span className="text-[8px] text-purple-400/80">Mitigação em Curso</span>
                  </div>
                      ...
                      <div className="flex justify-between items-start gap-2">
                        ...
                        {selectedMonthNum && (
                          <button
                            ...
                            className="px-2 py-1 bg-purple-950/30 hover:bg-purple-900/40 text-purple-400 text-[10px] font-mono border border-purple-500/30 rounded flex items-center gap-1 transition"
                          >
                            <span>✕</span>
                    ...
                    <div className="flex flex-wrap justify-between items-center text-[10px] font-mono text-gray-400 border-t border-[#2a2a2b] pt-2 mt-1">
                      <div className="flex gap-4 items-center">
                        <span className="flex items-center gap-1">
                          <span className="w-2.5 h-2.5 bg-purple-600 rounded-sm" />
                          {R.colOpened}
                        </span>
                        <span className="flex items-center gap-1">
                      ...
                      <div className="text-[9px] text-[#f2c811] uppercase tracking-wider flex items-center gap-1 bg-purple-950/20 px-1.5 py-0.5 rounded border border-purple-500/10">
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="flex justify-between">
                            ...
                            <span className="text-purple-400 font-bold">{m.opened}</span>
                          </p>
                          <p className="flex justify-between">
                  ...
                  <div className="bg-[#1e1e1e] p-4 rounded border border-[#2d2d2d] flex flex-col justify-between lg:col-span-2">
                    <div>
                      <div className="flex justify-between items-center border-b border-[#2d2d2d] pb-2 mb-3">
                        ...
                        <span className="text-[10px] bg-purple-400/10 text-purple-400 px-1.5 py-0.2 rounded font-mono font-bold border border-purple-500/20">
                              ...
                              >
                                ...
                                <div className="p-2.5 text-[10.5px] flex items-start gap-2 justify-between">
                                  <div className="space-y-0.5 truncate max-w-[210px] sm:max-w-xs">
                                    <h5 className="font-extrabold text-white flex items-center gap-1.5">
                                      <span className={`w-2 h-2 rounded-full ${
                                        ...
                                        r.status === 'ACTION_PLAN' ? 'bg-purple-500' : 'bg-purple-500 animate-pulse'
                                      }`} />
                                      <span className="text-purple-500">{r.code}</span>
                                  ...
                                  <div className="text-right shrink-0 font-mono text-[9px] space-y-1">
                                    ...
                                    <span className={`px-1.5 py-0.2 rounded font-bold uppercase ${
                                      isCritical ? 'bg-purple-950/20 text-purple-400 border border-purple-500/20' :
                                      isMedium ? 'bg-purple-950/20 text-purple-400 border border-purple-500/20' :
                                ...
                                {isExpanded && (
                                  <div className="px-2.5 pb-2.5 pt-1.5 border-t border-gray-850 font-sans text-[10px] space-y-2 bg-[#0c0c0d]">
                                    ...
                                    <div className="space-y-1">
                                      <p className="font-extrabold text-purple-500 font-mono text-[9px] uppercase tracking-wider flex items-center gap-1">
                                    ...
                                    {r.dateClosed ? (
                                      ...
                                      <p className="text-[9px] font-mono text-purple-400 flex items-center gap-1 mt-1">
                                        <Clock className="w-3.5 h-3.5" />
                                        <span>
                ...
                <tbody className="divide-y divide-[#2d2d2d]">
                  {filteredChecklistItems.slice(0, 10).map((i, idx) => (
                    <tr key={idx} className="hover:bg-[#1e1e1e]/60">
                      <td className="p-2 text-purple-500">{i.code}</td>
                      ...
                      <td className={`p-2 font-bold ${
                        ...
                        i.status === ChecklistStatus.REJECTED ? 'text-purple-400' : 'text-gray-400'
                      }`}>
                        {i.status}
                      </td>
                    </tr>
