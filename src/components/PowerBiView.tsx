          ...
          {activeTab === 'kpi' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
                ...
                {/* Under Review */}
                <div className="bg-[#1e1e1e] border-l-4 border-orange-400 p-4">
                  <span className="text-[10px] text-gray-500 uppercase font-bold text-center block">Qualificação Técnica</span>
                  <span className="text-3xl font-extrabold text-orange-400 text-center block mt-1">{reviewTotal}</span>
                  <p className="text-[9px] text-orange-550 text-center mt-1">Aguardando auditoria</p>
                </div>
          ...
          {activeTab === 'welds' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 font-mono text-center">
                ...
                <div className="bg-[#1e1e1e] p-3 border-l-4 border-orange-400 rounded">
                  <span className="text-[10px] text-gray-400 block uppercase font-bold">Taxa de Reparo</span>
                  <span className="text-2xl font-black text-orange-400 block mt-1">6.4%</span>
                  <p className="text-[8px] text-orange-500 mt-0.5">Abaixo do Limite Aceitável</p>
                </div>
            ...
            return (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 font-mono text-center">
                  ...
                  <div className="bg-[#1e1e1e] p-3 border-l-4 border-orange-400 rounded font-mono col-span-2 md:col-span-1">
                    <span className="text-[9px] text-gray-400 block uppercase font-bold">{R.timeAvg}</span>
                    <span className="text-xl font-extrabold text-orange-400 block mt-0.5">
                      {averageLeadTime} <span className="text-[10px] text-gray-500 font-normal">{R.days}</span>
                    </span>
                    <span className="text-[8px] text-orange-500/80">Lead Time de Reparo</span>
                  </div>
                </div>
