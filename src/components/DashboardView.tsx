    ...
    <div className="space-y-6">
      ...
      {currentUser?.isAdmin && (
        <section className="bg-gray-950/40 border border-blue-500/20 rounded-xl p-5 sm:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-4 rounded-lg flex items-center justify-between bg-gradient-to-r from-blue-950/10 to-blue-950/10 border-blue-500/20">
              <div>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-gray-900/60 border border-gray-800 rounded-lg p-4 flex flex-col justify-between">
          ...
          <div className="mt-4">
            <span className="text-3xl font-bold text-blue-300 font-mono">{analysisCount}</span>
            <p className="text-[10px] text-gray-500 font-mono truncate">
