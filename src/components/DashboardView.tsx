      ...
      {currentUser?.isAdmin && (
        <section className="bg-gray-950/40 border border-orange-500/20 rounded-xl p-5 sm:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-4 rounded-lg flex items-center justify-between bg-gradient-to-r from-orange-950/10 to-yellow-950/10 border-orange-500/20">
              <div>
